<?php
require_once('koneksi.php'); // adjust path if needed
...
<body class="min-h-screen flex">
  ...
  <div class="w-1/2 flex items-center justify-center p-12 bg-white">
    <div class="w-full max-w-md">
      ...
      <h1 class="text-[#333333] mb-3 text-2xl font-semibold">Log In</h1>
      ...
      <p class="text-[#737373] mt-6 text-center">
        ...
        <a href="register_user.php" class="text-[#2E7D32] font-semibold hover:underline">Register here</a>
      </p>
    </div>
  </div>
</body>
