...
$query = "SELECT id_komentar, id_resep, id_user, username_komentar, isi, tanggal 
          FROM komentar ORDER BY id_komentar DESC";
...
<title>Kelola Komentar - Dapoer Nusantara</title>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom px-4 py-3">
    <div class="container-fluid d-flex justify-content-between">
        <h1 class="text-white fs-4 m-0">Kelola Komentar</h1>
...
<div class="container bg-white rounded shadow mt-4 p-4">
    <h2 class="text-success fw-bold mb-4">Manage Komentar</h2>
...
function deleteKomentar(id) {
    if (confirm("Apakah kamu yakin ingin menghapus komentar ini?")) {
        window.location.href = "hapus_komentar.php?id=" + id;
    }
}
</script>
