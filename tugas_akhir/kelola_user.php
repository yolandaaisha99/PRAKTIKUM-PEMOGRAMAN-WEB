...
$query = "SELECT id_user, username, email, created_at AS joined 
...
<title>Kelola User - Dapoer Nusantara</title>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom px-4 py-3">
    <div class="container-fluid">
        <h1 class="text-white fs-4">Kelola User</h1>

        <div class="d-flex align-items-center gap-3 text-white fw-semibold">
            👑 <?= htmlspecialchars($username); ?>
            <a href="logout.php" class="btn btn-warning-custom">Logout</a>
            <a href="dashboard_admin.php" class="btn btn-light fw-semibold">Back</a>
        </div>
    </div>
</nav>
<div class="container bg-white rounded shadow mt-4 p-4">
    <h2 class="text-success fw-bold mb-4">Manage User</h2>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-warning-custom me-1"
                                onclick="editUser(<?= $row['id_user']; ?>)">Edit</button>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
